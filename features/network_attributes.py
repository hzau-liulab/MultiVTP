...
class PPIEncoder:
    def __init__(self, PPI_path="../input/PPInetwork", num_walks = 3, walk_length = 20):
        ...
        self.G = pickle.load(open(rf"{PPI_path}/hippie_grpah.pkl", 'rb'))
    ...
    def get_shotest_path_length(self):
        shortest_path_length = nx.shortest_path_length(self.G)
        return dict(shortest_path_length)
    ...
    def get_network_attributes(self):
        ...
        shortest_path_length = self.get_shotest_path_length()
