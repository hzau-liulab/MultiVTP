...
3. Download network attributes.    
   Global Topological Properties[Global Topological Properties](https://drive.google.com/file/d/1WDSQf_rUHxOlvipQ-2fPHkB5EKGnEajl/view?usp=drive_link): Download and place the global_topological_properties into `./input/PPInetwork/directory`.    
   Subgraphs[Subgraphs](https://drive.google.com/file/d/1fNAyrpgUU92InZqpkvme-CdmpEF4mO7x/view?usp=sharing) : Download and also place it into `./input/PPInetwork`.    
