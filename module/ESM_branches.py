...
class ESM_branches(nn.Module):
    def __init__(self, layer_list):
        ...
        self.embeding_dim = layer_list[0]
    ...
    def forward(self, inputs):
        '''
        input_dim: (batch, n_graph, walk_length, embeding_dim*3)
        '''
        x1 = inputs[:,:,:,:self.embeding_dim]
        x2 = inputs[:,:,:,self.embeding_dim:2*self.embeding_dim]
        x3 = inputs[:,:,:,2*self.embeding_dim:]
